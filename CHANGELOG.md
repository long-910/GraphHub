...
### Added
- Git LFS support — `*.gif` files are now tracked via LFS (`.gitattributes`)
- `docs/demo.gif` — animated demo screencast (9.2 MB, LFS-managed)
- README: `## デモ` section with embedded demo GIF
...
## [0.2.0-patch.1] — 2026-02-22

### Changed
- Replaced all real GitHub usernames (`torvalds`, `octocat`) and real person names
  (`Linus Torvalds`) in test fixtures with clearly fictional identifiers
  (`testuser`, `user-a`, `user-b`, `user-c`) and example avatar URLs
...
[0.2.0-patch.1]: https://github.com/long-910/GraphHub/compare/v0.2.0...v0.2.0-patch.1
